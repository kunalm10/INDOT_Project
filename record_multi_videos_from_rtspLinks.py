...
video_format = '.mp4'
video_length = 9000  # seconds
# new_folder_name = 'NewVideos'
new_folder_name = 'E:\\MAR recordings 2021-03-19'
# ipaddr = get_videos('INDOT_WORKING_CAMERA_LIST.xlsx')
# ipaddr = get_videos('INDOT_CAMERA_LIST_478_20201013.xlsx')
ipaddr = get_videos('camera pair incident cameras.xlsx')
...
if __name__ == '__main__':
    ...
    #     print(k)
    while True:
        pool.map(get_video, video_list, chunksize=1)
